   ...
   <nav>
      <div class="nav__bar">
        ...
        <ul class="nav__links" id="nav-links">
          <li><a href="renter book.jsp">Home</a></li>
  ...
  <form>
    <input type="text" placeholder="Enter Address">
     <input type="text" placeholder="Enter City">
      <input type="text" placeholder="Enter Room Owner Mobile">
      <input type="text" placeholder="Enter Room Rate Per Day">
     <label for=#photo>Enter Room Photo</label> 
    <input type="file" id="photo" accept="image/*" placeholder="Choose Room Photo">
