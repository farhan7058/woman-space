   ...
   <nav>
    ...
    <header class="header" id="home">
      <div class="section__container header__container">
        ...
        <a class="btn btn-outline-dark btn-lg" href="ower loging.jsp" >Owner Login</a>
  <a href="renter loging.jsp"  class="btn btn-outline-dark btn-lg">Tourist Login</a>
    <a class="btn btn-outline-dark btn-lg" href="owner post.jsp" >upload room</a>
  <a href="renter book.jsp"  class="btn btn-outline-dark btn-lg">book room</a>
      </div>
    </header>
